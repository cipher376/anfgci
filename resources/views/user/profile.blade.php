...
<div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Account</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Profile</a> </div> <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
...
@endif
                                ...
                                {{ csrf_field() }} 
                                    ...
                                    <div class="col-span-12 xl:col-span-4">
                                        ...
                                        <div class="border border-gray-200 rounded-md p-5">
                                            ...
                                            <img id="blah" alt="" class="rounded-md" src="{{ asset('dist/images/img2.png') }}">
                                ...
                                <div class="grid grid-cols-12 gap-5">
                                    ...
                                    <div class="mt-3">
                                            ...
                                            <input name="firstname" type="text" class="input w-full border mt-2" value="{{ old('firstname') }}">
                                        </div>
                                        <div class="mt-3">
                                        ...
                                        <div class="mt-3">
                                            <label>State</label>
                                            <input name="state" type="text" class="input w-full border mt-2" value="{{ old('state') }}">
                                        </div>
                                    </div>
                                    <div class="col-span-12 xl:col-span-6" data-select2-id="21">
                                    <div class="mt-3">
                                            <label>Lastname</label>
                                            <input name="lastname" type="text" class="input w-full border mt-2" value="{{ old('lastname') }}">
                                        </div>
                                        <div class="mt-3">
                                            <label>Town</label>
                                            <input name="town" type="text" class="input w-full border mt-2" value="{{ old('town') }}">
                                        </div>

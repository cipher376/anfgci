...
@section('content')
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Administration</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">My Sermons</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
...
<a href="/manage/sermons" class="button w-24 mr-1 mb-2 bg-theme-9 text-white">All Sermons </a>
     ...
     <table class="table" style="font-size:14px;">
                    ...
                    <tr class="hover:bg-gray-200">
                        <td class=""> <input type="checkbox" name="sermon[]" class="input border mr-2" id="vertical-checkbox-chris-evans" value="{{$sermon->sermonID}}"></td>
                                ...
                                <td class="border-b whitespace-no-wrap">
                                    ...
                                    <a class="flex items-center mr-3" href="./sermons/view/{{ $sermon->sermonID}}"> <i data-feather="eye" class="w-4 h-4 mr-1"></i> Read </a>
                                     
                                    <?php if (Auth::user()->role=="manage-sub" && $sermon->status!=1 && $sermon->user_id==Auth::user()->name ){ ?>
                                        <a class="flex items-center mr-3" href="./sermons/edit/{{ $sermon->sermonID}}"> <i data-feather="check-square" class="w-4 h-4 mr-1"></i> Edit </a>
                                   
                                    <a class="flex items-center text-theme-6" href="./sermons/delete/{{ $sermon->sermonID}}"> <i data-feather="trash-2" class="w-4 h-4 mr-1"></i> Delete </a>
                                   
                                    <?php }else if(Auth::user()->role=="manage"){?>

                                        <a class="flex items-center mr-3" href="./sermons/edit/{{ $sermon->sermonID}}"> <i data-feather="check-square" class="w-4 h-4 mr-1"></i> Edit </a>
                                        <a class="flex items-center text-theme-6" id="deleteUser{{ $sermon->sermonID}}" data-userid="{{$sermon->sermonID}}" href="javascript:void(0)" onclick="showAlert({{ $sermon->sermonID}});" >

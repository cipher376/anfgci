...
@foreach($sermons as $sermon)
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Administration</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Edit Sermon</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i>{{ strip_tags(htmlspecialchars_decode(substr($sermon->title, 0,70) ))}}...</div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
...
<form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
                ...
                <div class="px-5 sm:px-20 mt-10 pt-3 border-gray-200">
                  ...
                  <form   method="POST" action="{{ route('sermons.update',$sermon->sermonID) }}" enctype="multipart/form-data">  
                  {{ method_field("PUT")}}

...
@section('content')
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Manage</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Videos</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
...
function senddel(){
    ...
    window.location="/manage/videos/deletefree/"+$('#app_id').val();

...
<div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Administration</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Church Report</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
...
@endif
                  ...
                  {{ csrf_field() }} 
                    ...
                    <div class="intro-y col-span-12 sm:col-span-6">
                        ...
                        <a href="/manage/churches/{{$church}}/reports" class="button w-40 justify-center block bg-theme-11 text-white ml-2">Back to report list</a>

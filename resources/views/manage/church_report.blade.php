...
<br/>
                ...
                <a href="/manage/church/{{$church}}/add_report" class="button text-white bg-theme-1 shadow-md mr-2">Add Report </a>
                <a href="/manage/churches/view/{{$church}}" class="button text-white bg-theme-11 shadow-md mr-2">Go back to Church </a>

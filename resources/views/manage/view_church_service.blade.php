...
<?php }else{?>
                    ...
                    <a href="/manage/church/{{$church->churchID}}/service/sermon/view/{{ $service->serviceID }}" class="w-8 h-8 rounded-full flex items-center justify-center border ml-2 text-gray-500 zoom-in tooltip" title="View Sermon of service"> <i class="w-3 h-3 fill-current" data-feather="eye"></i> </a>

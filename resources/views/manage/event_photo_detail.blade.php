...
<div class="intro-y flex items-center mt-8">
                    ...
                    {{ ucfirst($church->name) }} | Event Photo Detail
                    </h2>
                </div>
         ...
         @include('layouts.Church_Sidebar')
                   ...
                   {{ $event->title }} 
                    ...
                    <div class="intro-y text-gray-700 mt-3 text-xs sm:text-sm"> Posted  <span class="mx-1">•</span> {{ \Carbon\Carbon::parse($event->created_at)->diffForHumans() }} <span class="mx-1">•</span> <a href="{{ URL::previous() }}"><u>Go back to events</u></a></div>
                    <div class="intro-y mt-6">
                        <div class="news__preview image-fit">
                            <img alt="Midone Tailwind HTML Admin Template" class="rounded-md" src=" {{ $event->url }}">
                        </div>
                    </div>
                   
                    <div class="intro-y text-justify leading-relaxed">
                        <br/>
                   <?php  echo stripslashes($event->caption) ?>
                       </div>

...
<div class="intro-y flex items-center mt-8">
         ...
         @include('layouts.Church_Sidebar')
                   ...
                   {{ $events->title }}
                    ...
                    <div class="intro-y text-gray-700 mt-3 text-xs sm:text-sm"> Posted  <span class="mx-1">•</span> {{ \Carbon\Carbon::parse($events->created_at)->diffForHumans() }} </div>
                    <div class="intro-y mt-6">
                        <div class="news__preview image-fit">
                            <img alt="Midone Tailwind HTML Admin Template" class="rounded-md" src=" {{ $events->url }}">
                        </div>
                    </div>
                   
                    <div class="intro-y text-justify leading-relaxed">
                        <br/>
                   <?php  echo stripslashes($events->caption) ?>
                       </div>

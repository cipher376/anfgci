...
@section('content')
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Administration</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Premium Videos</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
...
{{ csrf_field() }}
                <a href="/manage/premium_add_video"  class="button w-24 mr-1 mb-2 bg-theme-9 text-white">Add Premium </a>

...
<div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Pastor</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">New Branch</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
...
@endif
            ...
            @foreach($countries as $country)
             ...
             @endforeach
                         ...
                         <input name="state" type="text" class="input w-full border flex-1" placeholder="state" value="{{ old('state') }}">
                         </div>
                     ...
                     <div class="intro-y col-span-12 sm:col-span-12">
                         ...
                         <input name="town" type="text" class="input w-full border flex-1" placeholder="town" value="{{ old('town') }}">
                     </div>

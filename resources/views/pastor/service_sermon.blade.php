...
<div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Pastor</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Sermon for Church Service</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
...
<form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
                ...
                <div class="px-5 sm:px-20 mt-10 pt-3 border-gray-200">
                  ...
                  <form   method="POST" action="./add_sermon" enctype="multipart/form-data">  
...
@endif
                  ...
                  {{ csrf_field() }} 
                    ...
                    <div class="intro-y col-span-12 sm:col-span-6">
                            ...
                            <input name="topic" type="text" class="input w-full border flex-1" placeholder="Sermon Topic" value="{{ old('topic') }}">
                            <input name="serviceid" type="hidden" class="input w-full border flex-1" value="{{ $service }}">
                        ...
                        <div class="intro-y col-span-12 sm:col-span-6">
                            ...
                            <input name="author" type="text" class="input w-full border flex-1" placeholder="Name of minister" value="{{ old('author') }}">
                           
                        </div>
                        <div class="intro-y col-span-12 sm:col-span-12">
                        <div class="mb-2">Sermon</div>
                        <textarea data-feature="basic" class="summernote" name="sermon">{{ old('sermon') }}</textarea> 

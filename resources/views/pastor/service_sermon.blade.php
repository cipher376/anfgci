...
@foreach($sermons as $sermon)
                    ...
                    <div class="intro-y text-gray-700 mt-3 text-xs sm:text-sm"><a href=""> <b>Posted</b> </a> <span class="mx-1">•</span> {{ \Carbon\Carbon::parse($sermon->created_at)->diffForHumans() }} 
                   <a href="" style="padding-left:10px"><b> Upload by</b> </a> <span class="mx-1">•</span> {{ $sermon->uploadby  }}
                   <a href="" style="padding-left:10px"><b> Author</b> </a> <span class="mx-1">•</span> {{ $sermon->author }}
                </div>

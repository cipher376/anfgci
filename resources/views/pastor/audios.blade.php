...
@section('content')
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Pastor</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Audios</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
...
function senddel(){
    ...
    window.location="/pastor/audio/delete/"+$('#app_id').val();

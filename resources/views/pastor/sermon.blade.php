...
@section('content')
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Pastor</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Sermons</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                    <div class="search hidden sm:block">
                        <form method="GET" action="/pastor/search">
...
<br/>
<form method="POST" action="{{route('postallow')}}">
{{ csrf_field() }} 
                    ...
                    <td class=""> <input type="checkbox" name="sermon[]" class="input border mr-2" id="vertical-checkbox-chris-evans" value="{{$sermon->sermonID}}"></td>
                                ...
                                <td class="border-b whitespace-no-wrap">
                                    ...
                                    <a class="flex items-center mr-3" href="./sermons/view/{{ $sermon->sermonID}}"> <i data-feather="eye" class="w-4 h-4 mr-1"></i> Read </a>
                                        ...
                                        <a class="flex items-center text-theme-6" id="deleteUser{{ $sermon->sermonID}}" data-userid="{{$sermon->sermonID}}" href="javascript:void(0)" onclick="showAlert({{ $sermon->sermonID}});" > <i data-feather="trash-2" class="w-4 h-4 mr-1"></i> Delete </a>
...
function senddel(){
    ...
    window.location="/pastor/sermons/delete/"+$('#app_id').val();

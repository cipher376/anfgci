                            ...
                            <tr>
                                ...
                                <td class="border-b w-5">
                                    ...
                                    <a class="flex items-center mr-3" href="/pastor/churches/view/{{ $church->churchID }}"> <i data-feather="eye" class="w-4 h-4 mr-1"></i> Detail </a>
                                            ...
                                            <a class="flex items-center text-theme-6" id="deleteUser{{ $church->churchID}}" data-userid="{{$church->churchID}}" href="javascript:void(0)" onclick="showAlert({{ $church->churchID}});" >

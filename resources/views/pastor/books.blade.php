...
@section('content')
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Pastor</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">books</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                    ...
                    <table class="table table-report table-report--bordered display datatable w-full" style="font-size:14px;">
                     ...
                     <img src="<?php echo PastorController::showbookCover($book->id); ?>" width="100%" />
                                ...
                                <td class="border-b w-5" width="10%">
                                    ...
                                    <a href="/pastor/book/view/{{$book->id}}" style="padding-right:20px">   <i data-feather="eye" class="w-4 h-4 mr-1"></i> </a>

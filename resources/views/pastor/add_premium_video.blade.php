             ...
             <div class="px-5 sm:px-20 mt-10 pt-3 border-gray-200">
                 ...
                 <div class="grid grid-cols-12 gap-4 row-gap-5 mt-5">
                     ...
                     <div class="intro-y col-span-12 sm:col-span-12">
                         ...
                         <input name="author" type="text" class="input w-full border flex-1" placeholder="name of author " value="{{ old('author') }}">
                     </div>
                     ...
                     <div class="intro-y col-span-12 sm:col-span-6">
                        ...
                        <input name="videofile" type="file" max-size="100000M"  /> </div>

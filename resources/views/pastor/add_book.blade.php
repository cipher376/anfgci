...
<div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Administration</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">New book</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
...
@endif
             ...
             <div class="px-5 sm:px-20 mt-10 pt-3 border-gray-200">
                 ...
                 <div class="grid grid-cols-12 gap-4 row-gap-5 mt-5">
                     ...
                     <div class="intro-y col-span-12 sm:col-span-12">
                         ...
                         <input name="author" type="text" class="input w-full border flex-1" placeholder="name of author " value="{{ old('artist') }}">
                     </div>

                     <div class="intro-y col-span-12 sm:col-span-12">
                         <div class="mb-2">Book type </div>
             ...
             <option>premium</option>
                     ...
                     <div class="intro-y col-span-12 sm:col-span-6">
                        <div class="mb-6">Upload book cover</div>
                            
                        <input name="imgfile" type="file"   /> </div>

                        <div class="intro-y col-span-12 sm:col-span-6">
                        <div class="mb-6" style="color:forestgreen">Upload Book (PDF)</div>
                            
                        <input name="file" type="file" max-size="100000M"  /> </div>
                    
                     <div class="intro-y col-span-12 flex items-center justify-center sm:justify-end mt-5">
                        
                         <button class="button w-40 justify-center block bg-theme-1 text-white ml-2">Save Book</button>
                     </div>
                 </div>

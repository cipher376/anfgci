...
@section('content')
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Pastor</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Premium Videos</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
...
{{ csrf_field() }}
                <a href="/pastor/premium_add_video"  class="button w-24 mr-1 mb-2 bg-theme-9 text-white">Add Premium </a>
               
                <a href="/pastor/video_list" class="button text-white bg-theme-1 shadow-md mr-2">Free Videos </a>
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    ...
                    <table class="table table-report table-report--bordered display datatable w-full" style="font-size:14px;">
                        ...
                        <img src="<?php echo PastorController::showVideoCover($video->photoID); ?>" width="100%" />
                                ...
                                <div class="font-medium whitespace-no-wrap">{{ $video->created_at }}</div>
                                </td>

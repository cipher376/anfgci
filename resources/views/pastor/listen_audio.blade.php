...
@section('content')
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Pastor</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Audio</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> Now Playing </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
...
<source src="{{$list->url}}" type="audio/mpeg">
...
<?php echo stripslashes($list->note); ?>
                        ...
                        <div class="col-span-12 xl:col-span-4 mt-6">
                            ...
                            @foreach($audios as $audio)
                                <div class="intro-y">
                                    <a href="/pastor/audio/listen/{{$audio->audioID}}">
                                ...
                                <a href="/pastor/audios" class="intro-y w-full block text-center rounded-md py-4 border border-dotted border-theme-15 text-theme-16">View More</a> 
                            </div>
                        </div>

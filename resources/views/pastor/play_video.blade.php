...
@section('content')
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Pastor</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Video</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> Now Playing </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
...
<div class="intro-y box p-5 mt-12 sm:mt-5">
   ...
   <!---- <img style="max-width: 100%;max-height: 50%; display: block;" alt="" class="rounded-t-md" src="<?php // echo PastorController::showAudioCover($list->audioID); ?>" style="height:200px" >
--->
...
<?php echo stripslashes($list->note); ?>
                                </div>
</div>
                        @endforeach 
                        <div class="col-span-12 xl:col-span-4 mt-6">
                            ...
                            @foreach($videos as $video)
                                <div class="intro-y">
                                    <a href="/pastor/videos/watch/{{$video->videoID}}">
                                    <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                        ...
                                        <div class="ml-4 mr-auto">
                                            <div class="font-medium">{{substr($video->title, 0,25) }}...</div>
                                ...
                                <a href="/pastor/premium_video" class="intro-y w-full block text-center rounded-md py-4 border border-dotted border-theme-15 text-theme-16">View More</a> 
                            </div>
                        </div>

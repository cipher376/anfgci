...
<div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">pastor</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="/pastor/churches/view/{{ $church->churchID }}" class="breadcrumb--active">{{ $church->name }}</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> Photo</div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
...
@endif
                 ...
                 <div class="intro-y col-span-12 sm:col-span-12">
                         ...
                         <input name="church" type="hidden" class="input w-full border flex-1" value="{{ $church->churchID }}">

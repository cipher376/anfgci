...
<html lang="en">
    ...
    <head>
        ...
        <title>Login - All Nations Full Gospel Church</title>
        <!-- BEGIN: CSS Assets-->
...
@if (session('status'))
                    ...
                    <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="intro-x login__input input input--lg border border-gray-300 block" name="email" value="{{ old('email') }}" placeholder="Enter your email" required>
                        ...
                        <div class="intro-x flex text-gray-700 text-xs sm:text-sm mt-4">
                            ...
                            <a style="padding-right:20px" href="{{ route('login') }}">Login</a> 
                             <a href="{{ route('register') }}">Create account</a> 
                        </div>
                        <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                        <button type="submit" class="button button--lg w-full xl:w-60 text-white bg-theme-1 xl:mr-3">

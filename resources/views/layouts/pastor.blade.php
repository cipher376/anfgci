...
<title>{{ config('app.name', 'Manage') }}</title>
    ...
    <body class="app">
        ...
        <div class="mobile-menu md:hidden">
            ...
            <li>
                        <a href="/pastor" class="menu menu--active">
                    ...
                    <li>
                        <a href="/pastor/branch" class="menu">
                            <div class="menu__icon"> <i data-feather="home"></i> </div>
                            <div class="menu__title"> Branch </div>
                        </a>
                    </li>
                ...
                <li>
                    ...
                    <li>
                        <a href="/pastor/profile/{{Auth::user()->id}}" class="menu">
        ...
        <div class="flex">
            ...
            <nav class="side-nav">
                ...
                <ul>
                    <li>
                        <a href="/pastor" class="side-menu side-menu--active">
                    ...
                    <li>
                        <a href="/pastor/branch" class="side-menu">
                    ...
                    <li>
                        <a href="/pastor/sermons" class="side-menu">
                    ...
                    <li>
                        <a href="/pastor/profile/{{ Auth::user()->id }}" class="side-menu">
